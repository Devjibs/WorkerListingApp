...
using WorkerListingApp.Services.DapperCommands;
using WorkerListingApp.Services.StoredProc;
using WorkerListingApp.DataAccess.Data;

namespace WorkerListingApp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IEmployeeRepository, EmployeeRepositoryDP>();
